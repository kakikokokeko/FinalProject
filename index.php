...
<body>
    ...
    <div class="login">
        ...
        <div class="loginAs">
            ...
            <div class="buttons">
                <a href="HTML/LOGIN/loginCashier.php" class="login-button cashier-button" <?php if ($isMobileDevice) echo 'style="display: none;"'; ?>><button class="bttn">CASHIER</button></a>
                <a href="HTML/LOGIN/loginAdmin.php" class="login-button"><button class="bttn">ADMIN</button></a>
            </div>
